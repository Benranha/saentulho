...
## A empresa (texto aprovado, verbatim)

Título: **"Empresa legalizada. Resíduo no destino certo."**

> "A S.A. Entulho atua na coleta, transporte e destinação adequada de resíduos
> da construção civil e materiais recicláveis em Manaus.
>
> Trabalhamos com licenciamento ambiental, equipe capacitada e veículos
> adequados para cada operação, garantindo segurança e responsabilidade em
> todas as etapas do serviço.
>
> Mais do que retirar o resíduo, nosso compromisso é garantir que ele seja
> encaminhado para uma destinação ambientalmente adequada, com a documentação
> necessária para assegurar sua rastreabilidade."

<details>
<summary>O texto anterior, do site antigo</summary>
...
setembro de 2026). A política em si **não entra na página**: ela é documento
interno de sistema de gestão, e quem está pedindo uma caçamba quer o
compromisso, não o sistema. Só a missão e os valores foram aproveitados.

**Missão**, verbatim do documento:

> "Prestar serviços completos e responsáveis para a gestão de resíduos, desde a
> coleta até a destinação final ambientalmente adequada, com segurança,
> conformidade legal, rastreabilidade, agilidade e qualidade."

> "Atender às necessidades de nossos clientes por meio de operações eficientes,
> legalmente conformes e sustentáveis, promovendo a melhoria contínua dos
> processos, a proteção do meio ambiente, a prevenção da poluição, a segurança
...
| Valorização das pessoas | Valorizar colaboradores, fornecedores e parceiros, com ambiente seguro, respeitoso e com oportunidades |
| Satisfação do cliente | Atendimento ágil, comunicação transparente e soluções confiáveis |
| Sustentabilidade | Incentivar práticas sustentáveis e a economia circular |
| Ética e transparência | Atuar com ética, transparência e responsabilidade em todas as relações e operações |
...
- Atende **Manaus, Iranduba e Manacapuru** — não é mais "toda Manaus"
- Aceita **Pix**, cartão de crédito e débito
- Frota: **caminhões poliguincho e VUC**, adequados a diferentes operações
- Telefone **(92) 3030-1112** · WhatsApp **(92) 99434-1227**
- A afirmação **"pioneira em Manaus com caminhão VUC"** saiu da página: não
  estava nos textos novos que a cliente aprovou, nem no do serviço nem no da
  frota. Era afirmação própria da empresa, sem fonte. Se ela quiser de volta,
  é uma linha.
